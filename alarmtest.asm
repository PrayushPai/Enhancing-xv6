...
_alarmtest:     file format elf64-littleriscv
...
slow_handler()
{
  ...
  b4:	642080e7          	jalr	1602(ra) # 6f2 <exit>
...
00000000000000dc <test0>:
{
 ...
 15c:	5ba080e7          	jalr	1466(ra) # 712 <write>
...
void __attribute__ ((noinline)) foo(int i, int *j) {
 ...
 1e8:	52e080e7          	jalr	1326(ra) # 712 <write>
...
00000000000002b8 <test2>:
{
 ...
 2de:	410080e7          	jalr	1040(ra) # 6ea <fork>
 ...
 33e:	3c0080e7          	jalr	960(ra) # 6fa <wait>
  if (status == 0) {
 ...
 37a:	39c080e7          	jalr	924(ra) # 712 <write>
 ...
 3a0:	356080e7          	jalr	854(ra) # 6f2 <exit>
    exit(0);
 3a4:	4501                	li	a0,0
 3a6:	00000097          	auipc	ra,0x0
 3aa:	34c080e7          	jalr	844(ra) # 6f2 <exit>
    printf("test2 passed\n");
...
test3()
{
 ...
 400:	fef43423          	sd	a5,-24(s0)
  ...
  if(a0 != 0xac)
 404:	0ac00713          	li	a4,172
 408:	02e78063          	beq	a5,a4,428 <test3+0x68>
    printf("%x test3 failed: register a0 changed\n", &a0);
 40c:	fe840593          	addi	a1,s0,-24
 410:	00001517          	auipc	a0,0x1
 414:	9c850513          	addi	a0,a0,-1592 # dd8 <malloc+0x29c>
 418:	00000097          	auipc	ra,0x0
 41c:	66c080e7          	jalr	1644(ra) # a84 <printf>
  else
    printf("test3 passed\n");
 ...
 42c:	9d850513          	addi	a0,a0,-1576 # e00 <malloc+0x2c4>
 430:	00000097          	auipc	ra,0x0
 434:	654080e7          	jalr	1620(ra) # a84 <printf>
 438:	b7e5                	j	420 <test3+0x60>

000000000000043a <main>:
{
 ...
 446:	c9a080e7          	jalr	-870(ra) # dc <test0>
  test1();
 44a:	00000097          	auipc	ra,0x0
 44e:	da4080e7          	jalr	-604(ra) # 1ee <test1>
  test2();
 452:	00000097          	auipc	ra,0x0
 456:	e66080e7          	jalr	-410(ra) # 2b8 <test2>
  test3();
 45a:	00000097          	auipc	ra,0x0
 45e:	f66080e7          	jalr	-154(ra) # 3c0 <test3>
  exit(0);
 462:	4501                	li	a0,0
 464:	00000097          	auipc	ra,0x0
 468:	28e080e7          	jalr	654(ra) # 6f2 <exit>

000000000000046c <_main>:
//
...
_main()
{
 ...
 478:	fc6080e7          	jalr	-58(ra) # 43a <main>
  exit(0);
 47c:	4501                	li	a0,0
 47e:	00000097          	auipc	ra,0x0
 482:	274080e7          	jalr	628(ra) # 6f2 <exit>
...
strcpy(char *s, const char *t)
{
 ...
 49a:	fb75                	bnez	a4,48e <strcpy+0x8>
    ;
  return os;
}
 49c:	6422                	ld	s0,8(sp)
...
strcmp(const char *p, const char *q)
{
 ...
 4ac:	cb91                	beqz	a5,4c0 <strcmp+0x1e>
 4ae:	0005c703          	lbu	a4,0(a1)
 4b2:	00f71763          	bne	a4,a5,4c0 <strcmp+0x1e>
    p++, q++;
 4b6:	0505                	addi	a0,a0,1
 4b8:	0585                	addi	a1,a1,1
  while(*p && *p == *q)
 4ba:	00054783          	lbu	a5,0(a0)
 4be:	fbe5                	bnez	a5,4ae <strcmp+0xc>
  return (uchar)*p - (uchar)*q;
 4c0:	0005c503          	lbu	a0,0(a1)
}
 4c4:	40a7853b          	subw	a0,a5,a0
 4c8:	6422                	ld	s0,8(sp)
...
strlen(const char *s)
{
 ...
 4d8:	cf91                	beqz	a5,4f4 <strlen+0x26>
 4da:	0505                	addi	a0,a0,1
 4dc:	87aa                	mv	a5,a0
 4de:	4685                	li	a3,1
 4e0:	9e89                	subw	a3,a3,a0
 4e2:	00f6853b          	addw	a0,a3,a5
 4e6:	0785                	addi	a5,a5,1
 4e8:	fff7c703          	lbu	a4,-1(a5)
 4ec:	fb7d                	bnez	a4,4e2 <strlen+0x14>
    ;
  return n;
}
 4ee:	6422                	ld	s0,8(sp)
...
memset(void *dst, int c, uint n)
{
 ...
 4fc:	0800                	addi	s0,sp,16
  ...
  int i;
  for(i = 0; i < n; i++){
 4fe:	ca19                	beqz	a2,514 <memset+0x1c>
 500:	87aa                	mv	a5,a0
 502:	1602                	slli	a2,a2,0x20
 504:	9201                	srli	a2,a2,0x20
 506:	00a60733          	add	a4,a2,a0
    cdst[i] = c;
 50a:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
 50e:	0785                	addi	a5,a5,1
 510:	fee79de3          	bne	a5,a4,50a <memset+0x12>
  }
  return dst;
}
 514:	6422                	ld	s0,8(sp)
...
strchr(const char *s, char c)
{
 ...
 524:	cb99                	beqz	a5,53a <strchr+0x20>
    if(*s == c)
 526:	00f58763          	beq	a1,a5,534 <strchr+0x1a>
  for(; *s; s++)
 52a:	0505                	addi	a0,a0,1
 52c:	00054783          	lbu	a5,0(a0)
 530:	fbfd                	bnez	a5,526 <strchr+0xc>
      return (char*)s;
  return 0;
 532:	4501                	li	a0,0
}
 ...
 538:	8082                	ret
  return 0;
 53a:	4501                	li	a0,0
 53c:	bfe5                	j	534 <strchr+0x1a>

000000000000053e <gets>:
...
gets(char *buf, int max)
{
 ...
 564:	0344d863          	bge	s1,s4,594 <gets+0x56>
    cc = read(0, &c, 1);
 568:	4605                	li	a2,1
 56a:	faf40593          	addi	a1,s0,-81
 56e:	4501                	li	a0,0
 570:	00000097          	auipc	ra,0x0
 574:	19a080e7          	jalr	410(ra) # 70a <read>
    if(cc < 1)
 578:	00a05e63          	blez	a0,594 <gets+0x56>
    buf[i++] = c;
 57c:	faf44783          	lbu	a5,-81(s0)
 580:	00f90023          	sb	a5,0(s2)
    if(c == '\n' || c == '\r')
 584:	01578763          	beq	a5,s5,592 <gets+0x54>
 588:	0905                	addi	s2,s2,1
 58a:	fd679be3          	bne	a5,s6,560 <gets+0x22>
  for(i=0; i+1 < max; ){
 58e:	89a6                	mv	s3,s1
 590:	a011                	j	594 <gets+0x56>
 592:	89a6                	mv	s3,s1
      break;
  }
  buf[i] = '\0';
 594:	99de                	add	s3,s3,s7
 596:	00098023          	sb	zero,0(s3)
  return buf;
}
 59a:	855e                	mv	a0,s7
 59c:	60e6                	ld	ra,88(sp)
 59e:	6446                	ld	s0,80(sp)
 5a0:	64a6                	ld	s1,72(sp)
 5a2:	6906                	ld	s2,64(sp)
 5a4:	79e2                	ld	s3,56(sp)
 5a6:	7a42                	ld	s4,48(sp)
 5a8:	7aa2                	ld	s5,40(sp)
 5aa:	7b02                	ld	s6,32(sp)
 5ac:	6be2                	ld	s7,24(sp)
 5ae:	6125                	addi	sp,sp,96
 5b0:	8082                	ret

00000000000005b2 <stat>:
...
stat(const char *n, struct stat *st)
{
 ...
 5c6:	170080e7          	jalr	368(ra) # 732 <open>
  if(fd < 0)
 5ca:	02054563          	bltz	a0,5f4 <stat+0x42>
 5ce:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 5d0:	85ca                	mv	a1,s2
 5d2:	00000097          	auipc	ra,0x0
 5d6:	178080e7          	jalr	376(ra) # 74a <fstat>
 5da:	892a                	mv	s2,a0
  close(fd);
 5dc:	8526                	mv	a0,s1
 5de:	00000097          	auipc	ra,0x0
 5e2:	13c080e7          	jalr	316(ra) # 71a <close>
  return r;
}
 5e6:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 7c0:	f56080e7          	jalr	-170(ra) # 712 <write>
}
...
malloc(uint nbytes)
{
 ...
 c16:	b68080e7          	jalr	-1176(ra) # 77a <sbrk>
  if(p == (char*)-1)
