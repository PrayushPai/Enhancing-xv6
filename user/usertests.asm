...
0000000000001390 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    144e:	0f678793          	addi	a5,a5,246 # 8540 <malloc+0x2536>
...
00000000000045b4 <reparent>:
{
  ...
  exit(0);
    ...
    4608:	3ac50513          	addi	a0,a0,940 # 69b0 <malloc+0x9a6>
    460c:	00002097          	auipc	ra,0x2
    4610:	946080e7          	jalr	-1722(ra) # 5f52 <printf>
      exit(1);
    4614:	4505                	li	a0,1
    ...
    4624:	51850513          	addi	a0,a0,1304 # 6b38 <malloc+0xb2e>
    4628:	00002097          	auipc	ra,0x2
    462c:	92a080e7          	jalr	-1750(ra) # 5f52 <printf>
        exit(1);
    4630:	4505                	li	a0,1
...
0000000000004664 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    469a:	42250513          	addi	a0,a0,1058 # 6ab8 <malloc+0xaae>
    469e:	00002097          	auipc	ra,0x2
    46a2:	8b4080e7          	jalr	-1868(ra) # 5f52 <printf>
    exit(1);
    46a6:	4505                	li	a0,1
    ...
    46ce:	ace58593          	addi	a1,a1,-1330 # 6198 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4792:	53250513          	addi	a0,a0,1330 # 7cc0 <malloc+0x1cb6>
    4796:	00001097          	auipc	ra,0x1
    479a:	7bc080e7          	jalr	1980(ra) # 5f52 <printf>
    exit(1);
    479e:	4505                	li	a0,1
    ...
    47ae:	20650513          	addi	a0,a0,518 # 69b0 <malloc+0x9a6>
    47b2:	00001097          	auipc	ra,0x1
    47b6:	7a0080e7          	jalr	1952(ra) # 5f52 <printf>
    exit(1);
    47ba:	4505                	li	a0,1
    ...
    47fa:	4ea50513          	addi	a0,a0,1258 # 7ce0 <malloc+0x1cd6>
    47fe:	00001097          	auipc	ra,0x1
    4802:	754080e7          	jalr	1876(ra) # 5f52 <printf>
    exit(1);
    4806:	4505                	li	a0,1
...
000000000000481a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4864:	7aa080e7          	jalr	1962(ra) # 600a <malloc>
    ...
    489e:	47650513          	addi	a0,a0,1142 # 7d10 <malloc+0x1d06>
    48a2:	00001097          	auipc	ra,0x1
    48a6:	6b0080e7          	jalr	1712(ra) # 5f52 <printf>
      exit(1);
    48aa:	4505                	li	a0,1
...
00000000000048be <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4954:	3f050513          	addi	a0,a0,1008 # 7d40 <malloc+0x1d36>
    4958:	00001097          	auipc	ra,0x1
    495c:	5fa080e7          	jalr	1530(ra) # 5f52 <printf>
    exit(1);
    4960:	4505                	li	a0,1
    ...
    4970:	3fc50513          	addi	a0,a0,1020 # 7d68 <malloc+0x1d5e>
    4974:	00001097          	auipc	ra,0x1
    4978:	5de080e7          	jalr	1502(ra) # 5f52 <printf>
      exit(1);
    497c:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    49b4:	38050513          	addi	a0,a0,896 # 7d30 <malloc+0x1d26>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    49f4:	39850513          	addi	a0,a0,920 # 7d88 <malloc+0x1d7e>
    49f8:	00001097          	auipc	ra,0x1
    49fc:	55a080e7          	jalr	1370(ra) # 5f52 <printf>
    exit(1);
    4a00:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4a30:	30450513          	addi	a0,a0,772 # 7d30 <malloc+0x1d26>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4a56:	35e50513          	addi	a0,a0,862 # 7db0 <malloc+0x1da6>
    4a5a:	00001097          	auipc	ra,0x1
    4a5e:	4f8080e7          	jalr	1272(ra) # 5f52 <printf>
    exit(1);
    4a62:	4505                	li	a0,1
...
0000000000004a76 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4a9c:	33078793          	addi	a5,a5,816 # 7dc8 <malloc+0x1dbe>
    4aa0:	f6f43823          	sd	a5,-144(s0)
    4aa4:	00003797          	auipc	a5,0x3
    4aa8:	32c78793          	addi	a5,a5,812 # 7dd0 <malloc+0x1dc6>
    4aac:	f6f43c23          	sd	a5,-136(s0)
    4ab0:	00003797          	auipc	a5,0x3
    4ab4:	32878793          	addi	a5,a5,808 # 7dd8 <malloc+0x1dce>
    4ab8:	f8f43023          	sd	a5,-128(s0)
    4abc:	00003797          	auipc	a5,0x3
    4ac0:	32478793          	addi	a5,a5,804 # 7de0 <malloc+0x1dd6>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4b38:	28450513          	addi	a0,a0,644 # 6db8 <malloc+0xdae>
    4b3c:	00001097          	auipc	ra,0x1
    4b40:	416080e7          	jalr	1046(ra) # 5f52 <printf>
      exit(1);
    4b44:	4505                	li	a0,1
    ...
    4bb4:	23850513          	addi	a0,a0,568 # 7de8 <malloc+0x1dde>
    4bb8:	00001097          	auipc	ra,0x1
    4bbc:	39a080e7          	jalr	922(ra) # 5f52 <printf>
        exit(1);
    4bc0:	4505                	li	a0,1
    ...
    4bce:	22e50513          	addi	a0,a0,558 # 7df8 <malloc+0x1dee>
    4bd2:	00001097          	auipc	ra,0x1
    4bd6:	380080e7          	jalr	896(ra) # 5f52 <printf>
          exit(1);
    4bda:	4505                	li	a0,1
    ...
    4bf6:	21e50513          	addi	a0,a0,542 # 7e10 <malloc+0x1e06>
    4bfa:	00001097          	auipc	ra,0x1
    4bfe:	358080e7          	jalr	856(ra) # 5f52 <printf>
          exit(1);
    4c02:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4c84:	1a050513          	addi	a0,a0,416 # 7e20 <malloc+0x1e16>
    4c88:	00001097          	auipc	ra,0x1
    4c8c:	2ca080e7          	jalr	714(ra) # 5f52 <printf>
      exit(1);
    4c90:	4505                	li	a0,1
...
0000000000004cb8 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4ce6:	156b8b93          	addi	s7,s7,342 # 7e38 <malloc+0x1e2e>
  for(i = 0; i < N; i++){
    ...
    4d28:	11c50513          	addi	a0,a0,284 # 7e40 <malloc+0x1e36>
    4d2c:	00001097          	auipc	ra,0x1
    4d30:	226080e7          	jalr	550(ra) # 5f52 <printf>
        exit(1);
    4d34:	4505                	li	a0,1
    ...
    4d46:	0f650513          	addi	a0,a0,246 # 7e38 <malloc+0x1e2e>
  ...
  fd = open(".", 0);
    ...
    4d7e:	a9650513          	addi	a0,a0,-1386 # 6810 <malloc+0x806>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4df6:	06e50513          	addi	a0,a0,110 # 7e60 <malloc+0x1e56>
    4dfa:	00001097          	auipc	ra,0x1
    4dfe:	158080e7          	jalr	344(ra) # 5f52 <printf>
        exit(1);
    4e02:	4505                	li	a0,1
    ...
    4e16:	06e50513          	addi	a0,a0,110 # 7e80 <malloc+0x1e76>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	138080e7          	jalr	312(ra) # 5f52 <printf>
        exit(1);
    4e22:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4e4e:	05e50513          	addi	a0,a0,94 # 7ea8 <malloc+0x1e9e>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	100080e7          	jalr	256(ra) # 5f52 <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	b4a50513          	addi	a0,a0,-1206 # 69b0 <malloc+0x9a6>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	0e4080e7          	jalr	228(ra) # 5f52 <printf>
      exit(1);
    4e76:	4505                	li	a0,1
...
0000000000005014 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    509c:	e4850513          	addi	a0,a0,-440 # 7ee0 <malloc+0x1ed6>
  ...
  for(i = 0; ; i++){
    ...
    5100:	df450513          	addi	a0,a0,-524 # 7ef0 <malloc+0x1ee6>
    5104:	00001097          	auipc	ra,0x1
    5108:	e4e080e7          	jalr	-434(ra) # 5f52 <printf>
    exit(1);
    510c:	4505                	li	a0,1
    ...
    511c:	df850513          	addi	a0,a0,-520 # 7f10 <malloc+0x1f06>
    5120:	00001097          	auipc	ra,0x1
    5124:	e32080e7          	jalr	-462(ra) # 5f52 <printf>
      exit(1);
    5128:	4505                	li	a0,1
    ...
    5138:	dfc50513          	addi	a0,a0,-516 # 7f30 <malloc+0x1f26>
    513c:	00001097          	auipc	ra,0x1
    5140:	e16080e7          	jalr	-490(ra) # 5f52 <printf>
    exit(1);
    5144:	4505                	li	a0,1
    ...
    5154:	e0050513          	addi	a0,a0,-512 # 7f50 <malloc+0x1f46>
    5158:	00001097          	auipc	ra,0x1
    515c:	dfa080e7          	jalr	-518(ra) # 5f52 <printf>
      exit(1);
    5160:	4505                	li	a0,1
    ...
    5170:	e0450513          	addi	a0,a0,-508 # 7f70 <malloc+0x1f66>
    5174:	00001097          	auipc	ra,0x1
    5178:	dde080e7          	jalr	-546(ra) # 5f52 <printf>
      exit(1);
    517c:	4505                	li	a0,1
    ...
    518c:	e0050513          	addi	a0,a0,-512 # 7f88 <malloc+0x1f7e>
    5190:	00001097          	auipc	ra,0x1
    5194:	dc2080e7          	jalr	-574(ra) # 5f52 <printf>
      exit(1);
    5198:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    51ba:	d2a50513          	addi	a0,a0,-726 # 7ee0 <malloc+0x1ed6>
    ...
    51de:	dce50513          	addi	a0,a0,-562 # 7fa8 <malloc+0x1f9e>
    51e2:	00001097          	auipc	ra,0x1
    51e6:	d70080e7          	jalr	-656(ra) # 5f52 <printf>
    exit(1);
    51ea:	4505                	li	a0,1
...
00000000000051f4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    521e:	95650513          	addi	a0,a0,-1706 # 6b70 <malloc+0xb66>
    5222:	00001097          	auipc	ra,0x1
    5226:	d30080e7          	jalr	-720(ra) # 5f52 <printf>
    exit(1);
    522a:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    524c:	76850513          	addi	a0,a0,1896 # 69b0 <malloc+0x9a6>
    5250:	00001097          	auipc	ra,0x1
    5254:	d02080e7          	jalr	-766(ra) # 5f52 <printf>
    exit(1);
    5258:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    5290:	f0c58593          	addi	a1,a1,-244 # 6198 <malloc+0x18e>
    ...
    52ba:	6fa50513          	addi	a0,a0,1786 # 69b0 <malloc+0x9a6>
    52be:	00001097          	auipc	ra,0x1
    52c2:	c94080e7          	jalr	-876(ra) # 5f52 <printf>
     exit(1);
    52c6:	4505                	li	a0,1
    ...
    52d6:	cf650513          	addi	a0,a0,-778 # 7fc8 <malloc+0x1fbe>
    52da:	00001097          	auipc	ra,0x1
    52de:	c78080e7          	jalr	-904(ra) # 5f52 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    5312:	cd250513          	addi	a0,a0,-814 # 7fe0 <malloc+0x1fd6>
    5316:	00001097          	auipc	ra,0x1
    531a:	c3c080e7          	jalr	-964(ra) # 5f52 <printf>
}
  ...
  printf("kill... ");
    ...
    533e:	cbe50513          	addi	a0,a0,-834 # 7ff8 <malloc+0x1fee>
    5342:	00001097          	auipc	ra,0x1
    5346:	c10080e7          	jalr	-1008(ra) # 5f52 <printf>
  kill(pid1);
    534a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    536c:	ca050513          	addi	a0,a0,-864 # 8008 <malloc+0x1ffe>
    5370:	00001097          	auipc	ra,0x1
    5374:	be2080e7          	jalr	-1054(ra) # 5f52 <printf>
  wait(0);
    5378:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cc0:	90450513          	addi	a0,a0,-1788 # 85c0 <digits>
    5cc4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d80:	7ecc8c93          	addi	s9,s9,2028 # 8568 <malloc+0x255e>
  ...
  putc(fd, 'x');
    ...
    5d8e:	836b8b93          	addi	s7,s7,-1994 # 85c0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eb4:	6b098993          	addi	s3,s3,1712 # 8560 <malloc+0x2556>
        while(*s != 0){
    5eb8:	85ee                	mv	a1,s11
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5f96:	4ae7b783          	ld	a5,1198(a5) # 9440 <freep>
    ...
    5fbe:	00e6ea63          	bltu	a3,a4,5fd2 <free+0x4a>
{
  ...
  freep = p;
    ...
    6000:	44f73223          	sd	a5,1092(a4) # 9440 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    6032:	41253503          	ld	a0,1042(a0) # 9440 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    605a:	3ea90913          	addi	s2,s2,1002 # 9440 <freep>
  if(p == (char*)-1)
    605e:	5afd                	li	s5,-1
    6060:	a895                	j	60d4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6062:	0000a797          	auipc	a5,0xa
    6066:	c0678793          	addi	a5,a5,-1018 # fc68 <base>
    606a:	00003717          	auipc	a4,0x3
    606e:	3cf73b23          	sd	a5,982(a4) # 9440 <freep>
    ...
    6096:	3aa73723          	sd	a0,942(a4) # 9440 <freep>
      return (void*)(p + 1);
